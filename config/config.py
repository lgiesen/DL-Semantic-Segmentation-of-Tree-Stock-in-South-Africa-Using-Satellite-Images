...
class Configuration:
    def __init__(self):
        ...
        if platform in ['linux', 'linux2']:
            self.path_data = '/home/jovyan/work/saved_data/south_africa_tree_stock/'
            ...
            self.filepath_model = f'{self.model_path}UNet_20220307-0807_AdaDelta_weightmap_tversky_256.h5'

            self.filepath_satellite_exported = self.path_data + '2_satellite/2629BD_2018_exported.tif'
            ...
            self.path_labeled_data = f'{self.path_data}1_labeled_data/tif/'
            self.path_labeled_data_qgis = self.path_labeled_data + 'labeled_areas/labeled_areas_extracted_with_QGIS/'
        ...
        self.filepath_labels_bounding_boxes = self.path_labeled_data + 'label_polygons/labels-area-all/labels_bounding_box.shp'

        # 2. data preparation
        self.size = 256
        self.overlap = 32
        self.patch_size = (self.size,self.size,4) # Height * Width * (Input + Output) channels # (256,256,4)
